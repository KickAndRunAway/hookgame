...
public class Door : MonoBehaviour
{
    ...
    private string[] phrases = { "mfw keyless", "caught you lacking keys", "nuh uh", "you really thought", "tryna break in i see you", "i'm locked genius", "nothing is this easy in life" };
